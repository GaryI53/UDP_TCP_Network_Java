...
public abstract class   Process implements Comparable<Process> {
  ...
  protected float exponentialBurstTn; // created to store previous burst T(n)
  ...
  public int getWaitingTime() {
    ...
    // TODO
    //int burst = getRecentBurst();

    //System.out.println("This is the waiting time: " + ((getTurnaroundTime()-cpuTime)-blockedTime));
  ...
  public int getTurnaroundTime() {
    ...
    // TODO
    //System.out.println("This is the turnaround time: " + (terminatedTime - createdTime));
  ...
  //Used to store current burst exponential to date
  public float getExponentialBurstTn() {
    return exponentialBurstTn;
  }

  public void setExponentialBurstTn(float newExpo) {
    exponentialBurstTn = newExpo;
  }
  /**
